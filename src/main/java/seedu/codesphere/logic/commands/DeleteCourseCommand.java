...
import static seedu.codesphere.logic.commands.DeleteCommand.MESSAGE_DELETE_STUDENT_SUCCESS;
...
public class DeleteCourseCommand extends Command {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        return new CommandResult(String.format(MESSAGE_DELETE_STUDENT_SUCCESS, Messages.format(courseToDelete)));
    }
